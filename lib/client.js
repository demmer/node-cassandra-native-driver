...
function Client(options) {
    this.client = new addon.Client({hello: 123, goodbye: 456});
}
...
Client.prototype.query = function(query, params, options, callback, endCallback) {
    ...
    this._execute(args.query, args.params, args.options, args.callback, args.endCallback);
};
